...
$print_buffer .= "</td></tr>";
$print_buffer .= "<tr><td style='text-align:right'  ><b>Level : </b></td><td width=100%>" . $npc["level"] . "</td></tr>";
...
if ($npc["npc_spells_id"] > 0) {
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        $print_buffer .= "<td><table border=0><tr><td colspan=2 nowrap><b>This pet casts the following spells : </b><p>";
        $query = "
            SELECT
        ...
        if (mysql_num_rows($result2) > 0) {
            $print_buffer .= "</ul><li><b>Listname : </b>" . $g["name"];
            if ($g["attack_proc"] == 1) {
                $print_buffer .= " (Procs)";
            }
            $print_buffer .= "<ul>";
