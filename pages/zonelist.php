<?php
$Title="Zone List";
CreateToolTip("kunark", '<img src="http://media.giantbomb.com/uploads/0/1593/370230-everquest_ruins_of_kunark_large.jpg">');
CreateToolTip("velious", '<img src="http://upload.wikimedia.org/wikipedia/en/d/d5/EverQuest_-_The_Scars_of_Velious_Coverart.png">');
CreateToolTip("luclin", '<img src="http://upload.wikimedia.org/wikipedia/en/1/19/EverQuest_-_The_Shadows_of_Luclin_Coverart.png">');
CreateToolTip("pop", '<img src="http://cdn.wikimg.net/strategywiki/images/thumb/4/45/EverQuest_The_Planes_of_Power_cover_art.jpg/250px-EverQuest_The_Planes_of_Power_cover_art.jpg">');
CreateToolTip("loy", '<img src="http://upload.wikimedia.org/wikipedia/en/3/35/EverQuest_-_The_Legacy_of_Ykesha_Coverart.png">');
echo '';
